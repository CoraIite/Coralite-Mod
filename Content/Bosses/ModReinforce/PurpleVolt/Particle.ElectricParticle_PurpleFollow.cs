...
namespace Coralite.Content.Bosses.ModReinforce.PurpleVolt
{
    ...
    public class ElectricParticle_RedFollow : ElectricParticle
    {
        ...
        public static void Spawn(Vector2 parentCenter, Vector2 offset, Func<Vector2> GetParentCenter, float scale = 1f)
        {
            ...
            ElectricParticle_RedFollow p = PRTLoader.NewParticle<ElectricParticle_RedFollow>(parentCenter + offset, offset, Scale: scale);
            p.GetParentCenter = GetParentCenter;
        }
    }
}
