...
namespace Coralite.Content.Bosses.StoneImitator
{
    ...
    /// </summary>
    public class SIP_Explosion : ModProjectile
    {
    ...
    public class SIP_Strike : ModProjectile
    {
        ...
        {
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<SIP_Explosion>(), (int)(Projectile.damage * 0.8f), Projectile.knockBack, Projectile.owner);
        }
    ...
    public class SIP_Beam:ModProjectile
    {
        public override string Texture => AssetDirectory.OtherProjectiles + "Blank48x48";
