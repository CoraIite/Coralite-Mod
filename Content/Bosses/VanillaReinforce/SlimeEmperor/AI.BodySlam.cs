    ...
    public partial class SlimeEmperor
    {
        public void BodySlam()
        {
            switch ((int)SonState)
            {
                ...
                case 7: //弹弹
                    {
                        Scale = Vector2.Lerp(Scale, new Vector2(1.3f, 0.7f), 0.2f);
                ...
                case 8:
                    {
                        Scale = Vector2.Lerp(Scale, new Vector2(0.7f, 1.3f), 0.15f);
                ...
                case 9:
                    {
                        Scale = Vector2.Lerp(Scale, new Vector2(1.2f, 0.85f), 0.15f);
