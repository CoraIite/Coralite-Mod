...
namespace Coralite.Content.Bosses.VanillaReinforce.NightmarePlantera
{
    public abstract class BaseNightmareSparkle : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            //中心的闪光
            Helpers.ProjectilesHelper.DrawPrettyStarSparkle(Projectile.Opacity, 0, pos, ShineColor * 0.7f, ShineColor * 0.4f,
            ...
            //绘制一层小的更加亮的来让星星中心变亮点
            Helpers.ProjectilesHelper.DrawPrettyStarSparkle(Projectile.Opacity, 0, pos, Color.White * 0.7f, Color.White * 0.2f,
