...
namespace Coralite.Content.UI
{
    public class MagikeEnchantUI: BetterUIState
    {
        ...
        public static MagikeFactory_EnchantPool enchantPool = null;
        ...
        {
            if (enchantPool is null)
            {
                visible = false;
                return;
            }

            Vector2 worldPos = enchantPool.GetWorldPosition().ToScreenPosition();
