...
{
    public class PartJumpPage2 : KnowledgePage
    {
        ...
        public override void OnInitialize()
        {
            ...
            buttonList.Add(new Chapter2Jump(ParaTitles[0], () => CoraliteNoteUIState.BookPanel.GetPageIndex<ItemTransportation>()));
            //buttonList.Add(new Chapter2Jump(ParaTitles[1], () => CoraliteNoteUIState.BookPanel.GetPageIndex<PlaceFirstLens>()));
            //buttonList.Add(new Chapter2Jump(ParaTitles[2], () => CoraliteNoteUIState.BookPanel.GetPageIndex<StoneMaker>()));
            //buttonList.Add(new Chapter2Jump(ParaTitles[3], () => CoraliteNoteUIState.BookPanel.GetPageIndex<CraftAltar>()));
            //buttonList.Add(new Chapter2Jump(ParaTitles[4], () => CoraliteNoteUIState.BookPanel.GetPageIndex<ExpandProductionLine>()));
            //buttonList.Add(new Chapter2Jump(ParaTitles[5], () => CoraliteNoteUIState.BookPanel.GetPageIndex<INeedMoreMagike>()));
