...
namespace Coralite.Content.CoraliteNotes.SlimeChapter1
{
    public class Slime1DangerousPage : DangerousPage<Slime1Knowledge>
    {
        ...
        public override void AddNodes()
        {
            ...
            x += 80;
            DangerousButton b2 = NewButton(new Vector2(x, y), (int)Slime1Knowledge.Dangerous.LifeMaxBonus_2, KnowledgeButtonType.Rune).SetColor(red);
            x += 80;
            DangerousButton b3 = NewButton(new Vector2(x, y), (int)Slime1Knowledge.Dangerous.LifeMaxBonus_3, KnowledgeButtonType.Rune).SetColor(red);
            ...
            x += 80;
            DangerousButton b5 = NewButton(new Vector2(x, y), (int)Slime1Knowledge.Dangerous.DefenceBonus_2, KnowledgeButtonType.Metal).SetColor(Color.Gray);
            ...
            x += 80;
            DangerousButton b7 = NewButton(new Vector2(x, y), (int)Slime1Knowledge.Dangerous.SpeedBonus2_1, KnowledgeButtonType.Ball).SetColor(Color.ForestGreen);
            x += 80;
            DangerousButton b8 = NewButton(new Vector2(x, y), (int)Slime1Knowledge.Dangerous.SpeedBonus3_1, KnowledgeButtonType.Ball).SetColor(Color.LightSeaGreen);
            ...
            DangerousButton b13 = NewButton(new Vector2(x, y), (int)Slime1Knowledge.Dangerous.FlippyBonus_1, KnowledgeButtonType.Wild).SetColor(Color.CornflowerBlue);
            y += 80;
            ...
            DangerousButton b15 = NewButton(new Vector2(x, y), (int)Slime1Knowledge.Dangerous.AvatarBonus_1, KnowledgeButtonType.Wild).SetColor(Color.CornflowerBlue);
            y += 80;
            ...
            DangerousButton b17 = NewButton(new Vector2(x, y), (int)Slime1Knowledge.Dangerous.GelBallBonus_P1_2, KnowledgeButtonType.Wild).SetColor(Color.CornflowerBlue);
            y += 80;
            ...
            DangerousButton b19 = NewButton(new Vector2(x, y), (int)Slime1Knowledge.Dangerous.SpilkeBallBonus_P1_2, KnowledgeButtonType.Wild).SetColor(Color.CornflowerBlue);
            y += 80;
