...
{
    public class CrystallineMusicBox : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Sounds/Music/CrystallineSkyIslandDay"), ModContent.ItemType<CrystallineMusicBox>(), ModContent.TileType<CrystallineMusicBoxTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<CrystallineMusicBoxTile>(), 0);
            Item.rare = ItemRarityID.Lime;
        }
    }

    public class CrystallineMusicBoxTile : ModTile
    {
        public override string Texture => AssetDirectory.MagikeSeries2Item + Name;
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<CrystallineMusicBox>();
        }
