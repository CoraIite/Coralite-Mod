...
{
    public class SmeltiryItem : TackleFairyItem
    {
        public override string Texture => AssetDirectory.FairyItems + Name;
        public override int FairyType => CoraliteContent.FairyType<Smeltiry>();
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<SmeltiryProj>();
        }
    }

    public class Smeltiry : Fairy
    {
        public override string Texture => AssetDirectory.FairyItems + Name;
        public override int ItemType => ModContent.ItemType<SmeltiryItem>();
    ...
    public class SmeltiryProj : BaseFairyProjectile
    {
        public override string Texture => AssetDirectory.FairyItems + "Smeltiry";
