...
{
    public class BudsFairyItem : TackleFairyItem
    {
        public override string Texture => AssetDirectory.FairyItems + Name;
        public override int FairyType => CoraliteContent.FairyType<BudsFairy>();
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<BudsFairyProj>();
        }
    }

    public class BudsFairy : Fairy
    {
        public override string Texture => AssetDirectory.FairyItems + Name;
        public override int ItemType => ModContent.ItemType<BudsFairyItem>();
    ...
    public class BudsFairyProj : BaseFairyProjectile
    {
        public override string Texture => AssetDirectory.FairyItems + "BudsFairy";
