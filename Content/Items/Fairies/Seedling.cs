...
{
    public class SeedlingItem : TackleFairyItem
    {
        public override string Texture => AssetDirectory.FairyItems + Name;
        public override int FairyType => CoraliteContent.FairyType<Seedling>();
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<SeedlingProj>();
        }
    }

    public class Seedling : Fairy
    {
        public override string Texture => AssetDirectory.FairyItems + Name;
        public override int ItemType => ModContent.ItemType<SeedlingItem>();
    ...
    public class SeedlingProj : BaseFairyProjectile
    {
        public override string Texture => AssetDirectory.FairyItems + "Seedling";
