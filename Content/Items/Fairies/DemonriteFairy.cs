...
{
    public class DemonriteFairyItem : TackleFairyItem
    {
        public override string Texture => AssetDirectory.FairyItems + Name;
        public override int FairyType => CoraliteContent.FairyType<DemonriteFairy>();
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<DemonriteFairyProj>();
        }
    }

    public class DemonriteFairy : Fairy
    {
        public override string Texture => AssetDirectory.FairyItems + Name;
        public override int ItemType => ModContent.ItemType<DemonriteFairyItem>();
    ...
    public class DemonriteFairyProj : BaseFairyProjectile
    {
        public override string Texture => AssetDirectory.FairyItems + "DemonriteFairy";
