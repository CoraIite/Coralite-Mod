...
{
    public class BlackHoleFairyARItem : TackleFairyItem
    {
        public override string Texture => AssetDirectory.FairyItems + Name;
        public override int FairyType => CoraliteContent.FairyType<BlackHoleFairyAR>();
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<BlackHoleFairyARProj>();
        }
    }

    public class BlackHoleFairyAR : Fairy
    {
        public override string Texture => AssetDirectory.FairyItems + Name;
        public override int ItemType => ModContent.ItemType<BlackHoleFairyARItem>();
    ...
    public class BlackHoleFairyARProj : BaseFairyProjectile
    {
        public override string Texture => AssetDirectory.FairyItems + "BlackHoleFairyAR";
        ...
        {
            return (Timer * 0.1f + Projectile.key * MathHelper.TwoPi / 6).ToRotationVector2() * Math.Clamp(Timer / 120f, 0, 1) * 3;
        }
