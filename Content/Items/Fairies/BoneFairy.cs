...
{
    public class BoneFairyItem : TackleFairyItem
    {
        public override string Texture => AssetDirectory.FairyItems + Name;
        public override int FairyType => CoraliteContent.FairyType<BoneFairy>();
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<BoneFairyProj>();
        }
    }

    public class BoneFairy : Fairy
    {
        public override string Texture => AssetDirectory.FairyItems + Name;
        public override int ItemType => ModContent.ItemType<BoneFairyItem>();
    ...
    public class BoneFairyProj : BaseFairyProjectile
    {
        public override string Texture => AssetDirectory.FairyItems + "BoneFairy";
