...
{
    public class SpiderFairyItem : TackleFairyItem
    {
        public override string Texture => AssetDirectory.FairyItems + Name;
        public override int FairyType => CoraliteContent.FairyType<SpiderFairy>();
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<SpiderFairyProj>();
        }
    }

    public class SpiderFairy : Fairy
    {
        public override string Texture => AssetDirectory.FairyItems + Name;
        public override int ItemType => ModContent.ItemType<SpiderFairyItem>();
    ...
    public class SpiderFairyProj : BaseFairyProjectile
    {
        public override string Texture => AssetDirectory.FairyItems + "SpiderFairy";
