...
namespace Coralite.Content.Items.Fairies.ColorSeries
{
    ...
    {
        public override string Texture => AssetDirectory.ColorFairySeries + "RedFairy";
            ...
            switch (State)
            {
                ...
                case AIStates.Backing:
                    if (Main.rand.NextBool(3))
                        Helper.SpawnTrailDust(center, velocity, Projectile.width, DustID.CrimsonTorch, Main.rand.NextFloat(0.1f, 0.5f));
                    break;
                case AIStates.Skill:
                default:
                    Helper.SpawnTrailDust(center, velocity, Projectile.width, DustID.CrimsonTorch, Main.rand.NextFloat(0.1f, 0.5f));
        ...
        {
            return (Timer * 0.1f + Projectile.key * MathHelper.TwoPi / 6).ToRotationVector2() * 2;
        }
