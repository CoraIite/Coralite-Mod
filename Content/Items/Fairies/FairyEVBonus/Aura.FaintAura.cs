...
{
    public class FaintAura() : BaseMaterial(Item.CommonMaxStack, Item.sellPrice(0, 0, 0, 2)
        , ItemRarityID.Green, AssetDirectory.FairyEVBonus)
    {
        ...
        public override bool PreDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                Color c = Main.hslToRgb(new Vector3((Main.GlobalTimeWrappedHourly + i / 3f) % 1, 0.8f, 0.8f)) * 0.15f;
                c.A = 0;
                tex.QuickCenteredDraw(spriteBatch, pos, c, 0, scale);

                rot += MathHelper.TwoPi / 3;
            }
        ...
        public override bool PreDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, ref float rotation, ref float scale, int whoAmI)
        {
            ...
            tex.QuickCenteredDraw(spriteBatch, pos2, alphaColor, rotation, scale);
