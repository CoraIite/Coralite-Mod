...
{
    public class BubbleFairyItem : TackleFairyItem
    {
        public override string Texture => AssetDirectory.FairyItems + Name;
        public override int FairyType => CoraliteContent.FairyType<BubbleFairy>();
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<BubbleFairyProj>();
        }
    }

    public class BubbleFairy : Fairy
    {
        public override string Texture => AssetDirectory.FairyItems + Name;
        public override int ItemType => ModContent.ItemType<BubbleFairyItem>();
    ...
    public class BubbleFairyProj : BaseFairyProjectile
    {
        public override string Texture => AssetDirectory.FairyItems + "BubbleFairy";
