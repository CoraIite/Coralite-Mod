...
{
    public class LavaLens : BaseMagikePlaceableItem
    {
        public LavaLens() : base(TileType<LavaLensTile>(), Item.sellPrice(0, 0, 10, 0), RarityType<MagikeCrystalRarity>(), 50)
        { }
    ...
    public class LavaLensTile : BaseCostItemLensTile
    {
