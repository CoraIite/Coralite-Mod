...
namespace Coralite.Content.Items.Magike.MultPrisms
{
    ...
    {
        public CrimtaneTriprism() : base(TileType<CrimtaneTriprismTile>(), Item.sellPrice(0, 0, 50, 0), RarityType<MagikeCrystalRarity>(), 25)
        { }
    ...
    public class CrimtaneTriprismTile : BaseRefractorTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            TileObjectData.newTile.HookPostPlaceMyPlayer = new PlacementHook(GetInstance<CrimtaneTriprismEntity>().Hook_AfterPlacement, -1, 0, true);
    ...
    public class CrimtaneTriprismEntity : MagikeSender_Line
    {
        public const int sendDelay = 4 * 60 + 30;
        public int sendTimer;
        public CrimtaneTriprismEntity() : base(50, 10 * 16, 3) { }

        public override int HowManyPerSend => 15;

        public override ushort TileType => (ushort)TileType<CrimtaneTriprismTile>();
