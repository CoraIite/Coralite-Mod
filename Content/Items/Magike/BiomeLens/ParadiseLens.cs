...
namespace Coralite.Content.Items.Magike.BiomeLens
{
    ...
    public class ParadiseLensTile : OldBaseLensTile
    {
        public override void SetStaticDefaults()
        {
            ...
            TileObjectData.newTile.HookPostPlaceMyPlayer = new PlacementHook(GetInstance<ParadiseLensEntity>().Hook_AfterPlacement, -1, 0, true);
    ...
    public class ParadiseLensEntity : MagikeGenerator_Normal
    {
        public const int sendDelay = 10 * 60;
        public int sendTimer;
        public ParadiseLensEntity() : base(600, 5 * 16, 10 * 60) { }

        public override ushort TileType => (ushort)TileType<ParadiseLensTile>();

        public override int HowManyPerSend => 18;
