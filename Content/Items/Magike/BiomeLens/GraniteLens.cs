...
{
    public class GraniteLens : BaseMagikePlaceableItem
    {
        public GraniteLens() : base(TileType<GraniteLensTile>(), Item.sellPrice(0, 0, 50, 0), RarityType<MagikeCrystalRarity>(), 50)
        { }
