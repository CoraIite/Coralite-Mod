...
{
    public class MoonlightLens : BaseMagikePlaceableItem, IMagikeGeneratorItem, IMagikeSenderItem
    {
        public MoonlightLens() : base(TileType<MoonlightLensTile>(), Item.sellPrice(0, 0, 10, 0), RarityType<MagicCrystalRarity>(), 50)
        { }
    ...
    public class MoonlightLensTile : BaseCostItemLensTile
    {
        public override void SetStaticDefaults()
        {
            ...
            TileObjectData.newTile.HookPostPlaceMyPlayer = new PlacementHook(GetInstance<MoonlightLensEntity>().Hook_AfterPlacement, -1, 0, true);
    ...
    public class MoonlightLensEntity : MagikeGenerator_Normal
    {
        public const int sendDelay = 10 * 60;
        public int sendTimer;
        public MoonlightLensEntity() : base(40, 5 * 16, 11 * 60) { }

        public override ushort TileType => (ushort)TileType<MoonlightLensTile>();
        ...
        {
            MagikeHelper.SpawnDustOnGenerate(2, 3, Position, Color.MediumPurple, DustID.FireworksRGB);
        }
    }
}
