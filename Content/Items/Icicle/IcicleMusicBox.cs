...
{
    public class IcicleMusicBox : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Sounds/Music/IcyColdStream"), ModContent.ItemType<IcicleMusicBox>(), ModContent.TileType<IcicleMusicBoxTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<IcicleMusicBoxTile>(), 0);
            Item.rare = ItemRarityID.Cyan;
        }
    }

    public class IcicleMusicBoxTile : ModTile
    {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<IcicleMusicBox>();
        }
