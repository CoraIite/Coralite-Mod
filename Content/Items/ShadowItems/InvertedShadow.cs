...
namespace Coralite.Items
{
    public class InvertedShadow : ModItem
    {
        ...
        {
            Projectile.NewProjectile(source, player.Center, Vector2.Zero, ProjectileType<DrawInvertedPlayerProj>(), (int)(damage*1.3f), knockback, player.whoAmI);
