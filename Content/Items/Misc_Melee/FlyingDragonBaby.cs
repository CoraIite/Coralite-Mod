...
{
    public class FlyingDragonBaby : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<FlyingDragonBabyProj>(); // The projectile is what makes a shortsword work
        }
        ...
        public void Transform()
        {
            if (!CoraliteWorld.CoralCatWorld)
            {
                ...
                Item.SetDefaults(ItemID.DD2SquireBetsySword);
            }
        }
    }

    public class FlyingDragonBabyProj : ModProjectile
    {
        public override string Texture => AssetDirectory.Misc_Melee + "FlyingDragonBaby";
        ...
        public override void SetDefaults()
        {
            Projectile.Size = new Vector2(56); // This sets width and height to the same value (important when projectiles can rotate)
