...
namespace Coralite.Content.Items.Misc_Melee
{
    public class Excatbar : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shootSpeed = 2f;
            Item.shoot = ModContent.ProjectileType<ExcatbarProj>(); // The projectile is what makes a shortsword work
        }
        ...
        public void Transform()
        {
            if (!CoraliteWorld.coralCatWorld)
            {
                ...
                Item.SetDefaults(ItemID.Excalibur);
            }
        }
    }

    public class ExcatbarProj : ModProjectile
    {
        public override string Texture => AssetDirectory.Misc_Melee + "Excatbar";
