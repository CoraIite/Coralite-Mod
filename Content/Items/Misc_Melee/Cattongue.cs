...
namespace Coralite.Content.Items.Misc_Melee
{
    public class Cattongue : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shootSpeed = 2f;
            Item.shoot = ModContent.ProjectileType<CattongueProj>(); // The projectile is what makes a shortsword work
        }
        ...
        public void Transform(Item i)
        {
            if (!CoraliteWorld.CoralCat.Enabled)
            {
                ...
                i.SetDefaults(ItemID.Bladetongue);
            }
        }
    }

    public class CattongueProj : ModProjectile
    {
        public override string Texture => AssetDirectory.Misc_Melee + "Cattongue";
