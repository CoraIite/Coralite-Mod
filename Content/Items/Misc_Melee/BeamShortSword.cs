...
namespace Coralite.Content.Items.Misc_Melee
{
    public class BeamShortSword : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<BeamShortSwordProj>(); // The projectile is what makes a shortsword work
        }
        ...
        public void Transform()
        {
            if (!CoraliteWorld.coralCatWorld)
            {
                ...
                Item.SetDefaults(ItemID.BeamSword);
            }
        }
    }

    public class BeamShortSwordProj : ModProjectile
    {
        public override string Texture => AssetDirectory.Misc_Melee + "BeamShortSword";
