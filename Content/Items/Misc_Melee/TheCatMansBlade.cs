...
{
    public class TheCatMansBlade : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shootSpeed = 2f;
            Item.shoot = ModContent.ProjectileType<TheCatMansBladeProj>(); // The projectile is what makes a shortsword work
        }
        ...
        public void Transform()
        {
            if (!CoraliteWorld.CoralCatWorld)
            {
                ...
                Item.SetDefaults(ItemID.TheHorsemansBlade);
            }
        }
    }

    public class TheCatMansBladeProj : ModProjectile
    {
        public override string Texture => AssetDirectory.Misc_Melee + "TheCatMansBlade";
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            if (!target.immortal && !target.SpawnedFromStatue && !NPCID.Sets.CountsAsCritter[target.type])
                Main.player[Projectile.owner].HorsemansBlade_SpawnPumpkin(target.whoAmI, (int)(damageDone * 1f), Projectile.knockBack);
        }
    }
}
