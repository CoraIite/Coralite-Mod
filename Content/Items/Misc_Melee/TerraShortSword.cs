...
namespace Coralite.Content.Items.Misc_Melee
{
    public class TerraShortSword : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<TerraShortSwordProj>(); // The projectile is what makes a shortsword work
        }

        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            float adjustedItemScale6 = player.GetAdjustedItemScale(Item);

            Projectile.NewProjectile(source, player.MountedCenter
                , velocity.SafeNormalize(Vector2.Zero) * 20f, ProjectileID.TerraBlade2Shot
                , damage, knockback, player.whoAmI, player.direction * player.gravDir, 18f, adjustedItemScale6);
            return true;
        }
        ...
        {
            CreateRecipe()
                .AddIngredient<TrueNightsCage>()
                .AddIngredient<TrueExcatbar>()
                .AddIngredient<BrokenHeroShortSword>()
        ...
        public void Transform(Item i)
        {
            if (!CoraliteWorld.CoralCat.Enabled)
            {
                ...
                i.SetDefaults(ItemID.TerraBlade);
            }
        }
    }

    public class TerraShortSwordProj : ModProjectile
    {
        public override string Texture => AssetDirectory.Misc_Melee + "TerraShortSword";
