...
{
    public class NightsCage : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shootSpeed = 2;
            Item.shoot = ModContent.ProjectileType<NightsCageProj>(); // The projectile is what makes a shortsword work
        }
        ...
        {
            CreateRecipe()
                .AddIngredient<TomatoButcherer>()
                .AddIngredient<Nuranasa>()
                .AddIngredient<BladeOfCatnip>()
                .AddIngredient<SmallVolcano>()
                .AddTile(TileID.DemonAltar)
                .AddCondition(craftCondition, () => CoraliteWorld.coralCatWorld)
                .Register();

            CreateRecipe()
                .AddIngredient<ShadowsBane>()
                .AddIngredient<Nuranasa>()
                .AddIngredient<BladeOfCatnip>()
                .AddIngredient<SmallVolcano>()
                .AddTile(TileID.DemonAltar)
        ...
        public void Transform()
        {
            if (!CoraliteWorld.coralCatWorld)
            {
                ...
                Item.SetDefaults(ItemID.NightsEdge);
            }
        }
    }

    public class NightsCageProj : ModProjectile
    {
        public override string Texture => AssetDirectory.Misc_Melee + "NightsCage";
