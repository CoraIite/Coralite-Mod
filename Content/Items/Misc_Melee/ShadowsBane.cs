...
{
    public class ShadowsBane : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shootSpeed = 2f;
            Item.shoot = ModContent.ProjectileType<ShadowsBaneProj>(); // The projectile is what makes a shortsword work
        }
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            Projectile.NewProjectile(source, searchCenter
                , vector54 * 0.001f, ProjectileID.LightsBane
                , (int)(damage * 0.5f), knockback, player.whoAmI, player.direction * player.gravDir, ai8);
            return true;
        }
        ...
        public void Transform()
        {
            if (!CoraliteWorld.coralCatWorld)
            {
                ...
                Item.SetDefaults(ItemID.LightsBane);
            }
        }
    }

    public class ShadowsBaneProj : ModProjectile
    {
        public override string Texture => AssetDirectory.Misc_Melee + "ShadowsBane";
