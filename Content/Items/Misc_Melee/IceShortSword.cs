...
namespace Coralite.Content.Items.Misc_Melee
{
    public class IceShortSword : ModItem
    {
        ...
        {
            int index = Projectile.NewProjectile(source, player.MountedCenter
                   , velocity.SafeNormalize(Vector2.Zero) * 8.5f, ProjectileID.IceBolt
        ...
        public void Transform()
        {
            if (!CoraliteWorld.CoralCatWorld)
            {
                ...
                Item.SetDefaults(ItemID.IceBlade);
            }
        }
    }

    public class IceShortSwordProj : ModProjectile
    {
        public override string Texture => AssetDirectory.Misc_Melee + "IceShortSword";
        ...
        public override void SetDefaults()
        {
            Projectile.Size = new Vector2(28); // This sets width and height to the same value (important when projectiles can rotate)
        ...
        public override void AI()
        {
            ...
            {
                int num13 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.IceRod, (Projectile.velocity.X * 0.2f) + (Main.player[Projectile.owner].direction * 3), Projectile.velocity.Y * 0.2f, 90, default, 1.5f);
