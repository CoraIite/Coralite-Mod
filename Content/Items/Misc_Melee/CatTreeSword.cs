...
{
    public class CatTreeSword : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<CatTreeSwordProj>(); // The projectile is what makes a shortsword work
        }

        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            Projectile.NewProjectile(source, player.MountedCenter
                , velocity.SafeNormalize(Vector2.Zero) * 7.5f, ProjectileID.OrnamentStar
    ...
    public class CatTreeSwordProj : ModProjectile
    {
        public override string Texture => AssetDirectory.Misc_Melee + "CatTreeSword";
