...
{
    public class TrueExcatbar : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<TrueExcatbarProj>(); // The projectile is what makes a shortsword work
        }

        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            Projectile.NewProjectile(source, player.MountedCenter
                , velocity.SafeNormalize(Vector2.Zero) * 15f, ProjectileID.LightBeam
        ...
        public void Transform()
        {
            if (!CoraliteWorld.coralCatWorld)
            {
                ...
                Item.SetDefaults(ItemID.TrueExcalibur);
            }
        }
    }

    public class TrueExcatbarProj : ModProjectile
    {
        public override string Texture => AssetDirectory.Misc_Melee + "TrueExcatbar";
