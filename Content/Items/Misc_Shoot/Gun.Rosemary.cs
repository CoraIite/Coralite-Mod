    ...
    public class Rosemary : ModItem
    {
        ...
        public override void UseAnimation(Player player)
        {
            if (Main.myPlayer == player.whoAmI)
            {
                ...
                Projectile.NewProjectile(player.GetSource_ItemUse(Item), player.Center, Vector2.Zero, ProjectileType<RosemaryHeldProj>(), Item.damage, Item.knockBack, player.whoAmI);
            }
        }
