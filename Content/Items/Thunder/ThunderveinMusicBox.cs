...
{
    public class ThunderveinMusicBox : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Sounds/Music/ThunderDragon"), ModContent.ItemType<ThunderveinMusicBox>(), ModContent.TileType<ThunderveinMusicBoxTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<ThunderveinMusicBoxTile>(), 0);
            Item.rare = ItemRarityID.Red;
        }
    }

    public class ThunderveinMusicBoxTile : ModTile
    {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<ThunderveinMusicBox>();
        }
