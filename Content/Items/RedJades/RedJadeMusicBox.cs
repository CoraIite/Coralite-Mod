...
{
    public class RedJadeMusicBox : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Sounds/Music/RedTorrent"), ModContent.ItemType<RedJadeMusicBox>(), ModContent.TileType<RedJadeMusicBoxTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<RedJadeMusicBoxTile>(), 0);
            Item.rare = ItemRarityID.Red;
        }
    }

    public class RedJadeMusicBoxTile : ModTile
    {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<RedJadeMusicBox>();
        }
