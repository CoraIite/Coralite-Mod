...
namespace Coralite.Content.WorldGeneration.MagikeShrineDatas
{
    ...
    {
        public override string SavePath => Path.Combine(StructurePath, "DesertLensData1_v2.nbt");
        public override void Load() => Mod.EnsureFileFromMod("Datas/StructureDatas/DesertLensData1_v2.nbt", SavePath);
#if DEBUG
