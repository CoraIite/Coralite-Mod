...
namespace Coralite.Content.Tiles.MagikeSeries1
{
    ...
    public class BasaltStalactiteBottom2Fake : BasaltStalactiteBottom2
    {
        public override string Texture => AssetDirectory.MagikeSeries1Tile + nameof(BasaltStalactiteBottom2);
