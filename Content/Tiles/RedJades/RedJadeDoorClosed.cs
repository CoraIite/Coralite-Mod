...
namespace Coralite.Content.Tiles.RedJades
{
    public class RedJadeDoorClosed : ModTile
    {
        ...
        {
            this.DoorClosedPrefab(ModContent.TileType<RedJadeDoorOpen>(), DustID.GemRuby, "赤玉门", Coralite.Instance.RedJadeRed);
        }
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<RedJadeDoor>());
        }
