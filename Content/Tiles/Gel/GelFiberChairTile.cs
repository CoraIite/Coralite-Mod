...
{
    public class GelFiberChairTile : ModTile
    {
        ...
        {
            this.ChairPrefab(DustID.Water, new Microsoft.Xna.Framework.Color(0, 138, 122));
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<GelFiberChair>();
