...
namespace Coralite.Core.Systems.FairyCatcherSystem
{
    ...
    {
        public static Color VeryCommonLevel_Brown = new(143, 86, 59);

        public static Dictionary<FairyRarity, Color> RarityColors = new()
        {
        ...
        public static Color RaritySP_Purple = new(215, 177, 255);
    }
}
