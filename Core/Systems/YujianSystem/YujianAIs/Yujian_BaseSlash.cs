...
{
    public abstract class Yujian_BaseSlash : YujianAI
    {
        protected readonly float turnSpeed;
        protected readonly float roughlyVelocity;
        protected readonly float halfShortAxis;
        protected readonly float halfLongAxis;
        protected readonly float startElliptical;
        protected readonly ISmoother smoother;
        ...
        public Yujian_BaseSlash(int startTime, int slashWidth, int slashTime, float startAngle, float totalAngle, float turnSpeed, float roughlyVelocity, float halfShortAxis, float halfLongAxis, ISmoother smoother)
        {
