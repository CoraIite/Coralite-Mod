...
namespace Coralite.Core.Systems.MagikeSystem.Remodels
{
    public class Ore : IMagikeCraftable
    {
        public void AddMagikeCraftRecipe()
        {
            ...
            MagikeCraftRecipe.CreateRecipe(ItemID.HallowedBar, ItemID.ChlorophyteBar, cost, 2)
            ...
            MagikeCraftRecipe.CreateRecipe(ItemID.ChlorophyteOre, ItemID.ShroomiteBar, cost, 2)
                .AddIngredient(ItemID.GlowingMushroom, 2)
                .AddCondition(Condition.DownedPlantera)
                .AddCondition(CoraliteConditions.NotInDigDigDig)
                .Register();

            MagikeCraftRecipe.CreateRecipe(ItemID.ChlorophyteOre, ItemID.SpectreBar, cost, 2)
