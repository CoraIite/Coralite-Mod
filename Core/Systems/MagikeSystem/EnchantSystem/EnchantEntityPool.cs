...
//        public IEnumerable<EnchantData> GetSonPool(int whichSlot, MagikeEnchant.Level level)
//        {
...
//        public IEnumerable<T> Find<T>(int whichSlot, MagikeEnchant.Level level) where T : EnchantData
//        {
//            return from d in _datas
...
//        public void FindAndRemoveAll<T>(int whichSlot, MagikeEnchant.Level level) where T : EnchantData
//        {
...
//        public void FindAndRemoveAll(int whichSlot, MagikeEnchant.Level level)
//        {
