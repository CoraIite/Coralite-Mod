...
{
    public abstract class BasePlantTileWithSeedling<T> : ModTile where T : BasePlantTileEntity
    {
        ...
        public BasePlantTileWithSeedling(string texture, short frameWidth, int frameCount, int seedlingType = 0, int plantType = 0, int rarePlantType = 0, bool pathHasName = false)
        {
            _Texture = texture;
