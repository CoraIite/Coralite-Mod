...
#pragma warning disable CS8974 // 将方法组转换为非委托类型
        ...
        public static void AddRediancie(Mod bcl)
        {
        ...
        public static void AddBabyIceDragon(Mod bcl)
        {
        ...
        public static void AddBloodiancie(Mod bcl)
        {
        ...
        public static void AddThunderveinDragon(Mod bcl)
        {
            List<int> ThunderveinDragonCollection = new()
                {
                    ...
                    ItemType<Content.Items.Thunder.ThunderveinDragonRelic>(),
                };
        ...
        public static void AddNightmarePlantera(Mod bcl)
        {
